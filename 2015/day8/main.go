...
func main() {
	...
	var codeRepLen int
	var escapedCodeRepLen int
	for _, line := range strings.Split(string(data), "\n") {
		codeRepLen += len(line)
		escapedCodeRepLen += len(fmt.Sprintf("%q", line))
	}
	...
	log.Println("Part one:", codeRepLen-inMemLen)
	log.Println("Part two:", escapedCodeRepLen-codeRepLen)
}
